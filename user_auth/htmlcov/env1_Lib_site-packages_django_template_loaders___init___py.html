...
<head>
    ...
    <title>Coverage for env1\Lib\site-packages\django\template\loaders\__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>env1\Lib\site-packages\django\template\loaders\__init__.py</b> :
